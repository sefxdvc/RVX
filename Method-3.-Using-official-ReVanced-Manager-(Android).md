...
### 3. Download [ReVanced Manager v1.4.0](https://github.com/revanced/revanced-manager/releases/tag/v1.4.0) from the official repo and install it on your device
